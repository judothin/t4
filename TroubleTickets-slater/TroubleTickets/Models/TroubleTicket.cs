...
namespace TroubleTickets.Models
{
    public class TroubleTicket
    {
        ...
        [Required]
        [ValidationLibrary.StringOptionsValidate(
        ...
        [ValidationLibrary.MyDate(ErrorMessage = "Future date entry not alowed")]
        public DateTime CreatedAt { get; set; }

        [Display(Name = "Date of solutions/closure.")]
        [DataType(DataType.DateTime), DisplayFormat(DataFormatString = "{0:MM/dd/yyyy hh:mm:ss tt}", ApplyFormatInEditMode = true)]
        [ValidationLibrary.MyDate(ErrorMessage = "Future date enty now allowed")]
