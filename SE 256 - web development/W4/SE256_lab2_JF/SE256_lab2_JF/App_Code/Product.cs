...
(
        ...
        public string Name
        {
            ...
            set
            {
                ...
                {
                    Errors.Add("Product name input contains bad word(s)");
                    return;
                }
        ...
        public string Manufacturer
        {
            ...
            set
            {
                if (ValidationLibrary.ContainsBadWords(value))
                {
                    Errors.Add("Manufacturer input contains bad word(s)");
                    return;
                }
        ...
        public class ProductSearchResult
        {
            ...
            {
                // Delete the prouduct from the database query
                string query = "DELETE FROM Products_t4 WHERE Id = @Id";
